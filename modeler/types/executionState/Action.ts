...
export class Action {
    ...
    public start(executionState: ExecutionState): ExecutionState {
        ...
        return new ExecutionState(availableStateInstances, blockedStateInstances, instanceLinks, resources, time, runningActions, objectiveArray);
    }
    ...
    public tryToFinish(executionState: ExecutionState): ExecutionState {
        if (this.canFinish()) {
            ...
            return new ExecutionState(executionState.availableStateInstances, executionState.blockedStateInstances,
                executionState.instanceLinks, executionState.resources, executionState.time, runningActions, executionState.objectives
            );
        }
    }
...
/*  
    TODO: scheduled for history necessary? maybe different name at least  
 ...
 */ 
    ...
    private finishInstantAction(executionState: ExecutionState): ExecutionState {
        ...
        return new ExecutionState(availableDataObjects, blockedDataObjects, instanceLinks, resources, time, runningActions, objectiveArray);
    }
}